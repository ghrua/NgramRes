...
#     --best-checkpoint-metric bleu --maximize-best-checkpoint-metric > $SAVE_DIR/log.train &
# let "gpuid=gpuid+1"
...
# do
#     SAVE_DIR=$DEST/results/iwslt14.$L1-$L2.5gram.alpha$alpha.dist$dist_size
#     mkdir -p $SAVE_DIR
#     CUDA_VISIBLE_DEVICES=$gpuid nohup fairseq-train \
...
# do
#     SAVE_DIR=$DEST/results/iwslt14.$L1-$L2.5gram.4shards.alpha$alpha.dist$dist_size
#     mkdir -p $SAVE_DIR
#     CUDA_VISIBLE_DEVICES=$gpuid nohup fairseq-train \
#         --task translation_with_ngram \
#         $DEST/data-bin/iwslt14.$L1-$L2/ \
...
#         --data2clst-map-path $DEST/data/iwslt14_en$L2/iwslt14.tokenized.en-$L2/data2clst_4shard_map_$L2.pt \
#         --ngram-alpha $alpha \
#         --ngram-dist-size $dist_size \
#         --ngram-min-dist-prob $min_dist_prob \
#         --ngram-module-path $DEST/KNQuery/ > $SAVE_DIR/log.train &
